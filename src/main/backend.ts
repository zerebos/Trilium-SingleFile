...
export default function setupNotes(singleFile: string, attrs: RenderAttributes) {
    ...
    const templateNote = api.searchForNote("#singleFileRenderer"); // api.createNewNote({parentNoteId: renderNote.note.noteId, type: "code", mime: "text/html", title: "SingleFile Renderer", content: ""});
